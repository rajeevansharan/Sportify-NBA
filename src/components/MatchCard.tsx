...
const FALLBACK_IMAGE =
  "https://via.placeholder.com/150x80/007AFF/FFFFFF?text=NBA";
...
const MatchCard: React.FC<MatchCardProps> = ({ match }) => {
  ...
  const isFav = useAppSelector((state: RootState) =>
    selectIsFavorite(state, match.idEvent)
  );
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.teamsContainer}>
          <View style={styles.teamRow}>
            <View
              style={[styles.teamDot, { backgroundColor: colors.primary }]}
            />
            <Text
          ...
          <View style={styles.teamRow}>
            <View
              style={[styles.teamDot, { backgroundColor: colors.textMuted }]}
            />
            <Text
              style={[styles.teamName, { color: colors.text }]}
              numberOfLines={1}
        ...
        <View style={styles.bottomInfo}>
          ...
          <View style={styles.leagueContainer}>
            ...
            />
            <Text
              style={[styles.leagueText, { color: colors.textMuted }]}
              numberOfLines={1}
            >
              {match.strLeague}
            </Text>
